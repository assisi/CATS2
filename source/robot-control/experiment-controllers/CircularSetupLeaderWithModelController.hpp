#ifndef CATS2_CIRCULAR_SETUP_LEADER_WITHMODEL_CONTROLLER_HPP
#define CATS2_CIRCULAR_SETUP_LEADER_WITHMODEL_CONTROLLER_HPP
 ...
 */
class CircularSetupLeaderWithModelController : public CircularSetupController
{
    Q_OBJECT
public:
    //! Constructor. Gets the robot and the settings.
    explicit CircularSetupLeaderWithModelController(FishBot* robot,
...
#endif // CATS2_CIRCULAR_SETUP_LEADER_WITHMODEL_CONTROLLER_HPP
