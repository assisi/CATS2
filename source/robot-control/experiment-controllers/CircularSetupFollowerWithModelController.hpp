#ifndef CATS2_CIRCULAR_SETUP_FOLLOWER_MODEL_CONTROLLER_HPP
#define CATS2_CIRCULAR_SETUP_FOLLOWER_MODEL_CONTROLLER_HPP

#include "CircularSetupController.hpp"

#include <Timer.hpp>

class CircularSetupFollowerWithModelController : public CircularSetupController
{
    Q_OBJECT
public:
    //! Constructor. Gets the robot and the settings.
    explicit CircularSetupFollowerWithModelController(FishBot* robot,
...
#endif // CATS2_CIRCULAR_SETUP_FOLLOWER_MODEL_CONTROLLER_HPP
