#include "CircularSetupFollowerWithModelController.hpp"

CircularSetupFollowerWithModelController::CircularSetupFollowerWithModelController(FishBot* robot,
                                                                 ExperimentControllerSettingsPtr settings):
    CircularSetupController(robot, settings, ExperimentControllerType::CIRCULAR_SETUP_FOLLOWER_MODEL)
{
 ...
 */
void CircularSetupFollowerWithModelController::start()
{
    // start the timer
 ...
 */
ExperimentController::ControlData CircularSetupFollowerWithModelController::step()
{
