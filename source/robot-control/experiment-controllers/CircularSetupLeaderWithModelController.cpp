#include "CircularSetupLeaderWithModelController.hpp"

#include <QtCore/QDebug>

CircularSetupLeaderWithModelController::CircularSetupLeaderWithModelController(FishBot* robot,
    ...
    CircularSetupController(robot, settings,
                            turningDirection == TurningDirection::CLOCK_WISE ?
                                ExperimentControllerType::CIRCULAR_SETUP_LEADER_CW_MODEL :
                                ExperimentControllerType::CIRCULAR_SETUP_LEADER_CCW_MODEL)
{
 ...
 */
// TODO
ExperimentController::ControlData CircularSetupLeaderWithModelController::step()
{
