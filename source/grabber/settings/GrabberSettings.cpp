 ...
 */
GrabberSettings& GrabberSettings::get()
{
    static GrabberSettings instance;
    return instance;
}
 ...
 */
bool GrabberSettings::init(QString configurationFileName, SetupType::Enum setupType, bool needTargetFrameSize)
{
