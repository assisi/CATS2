...
if [ "$(hostname)" = "fishtrack" ]; then
	...
	sudo rfcomm -i 00:1A:7D:DA:71:0A bind 0 10:00:E8:6C:F0:54 # A (PARIS)
	...
	sudo rfcomm -i 00:1A:7D:DA:71:0A bind 3 10:00:E8:6C:F0:5E # D (PARIS)
	#sudo rfcomm -i 5C:F3:70:75:00:BE bind 4 10:00:E8:6C:F0:59 # E (EPFL)
	sudo rfcomm -i 00:15:83:EF:00:30 bind 4 10:00:E8:6C:F0:59 # E (EPFL)
	sudo rfcomm -i 00:15:83:EF:00:30 bind 5 10:00:E8:6C:F0:5A # F (PARIS)
	...
	sudo rfcomm -i 00:1A:7D:DA:71:0A bind 9 10:00:E8:6C:F0:5E # J (PARIS)
