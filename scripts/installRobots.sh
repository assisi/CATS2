...
if [ "$(hostname)" = "fishtrack" ]; then
	sudo rfcomm -i 5C:F3:70:77:1A:84 bind 0 10:00:E8:6C:F0:54 # A (PARIS)
	...
	sudo rfcomm -i 00:1A:7D:DA:71:13 bind 4 10:00:E8:6C:F0:59 # E (EPFL)
	...
	sudo rfcomm -i 00:15:83:EF:00:2F bind 4 10:00:E8:6C:F0:59 # E (EPFL)
