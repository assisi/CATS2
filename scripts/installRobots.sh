...
if [ "$(hostname)" = "fishtrack" ]; then
	sudo rfcomm -i 5C:F3:70:77:1A:80 bind 0 10:00:E8:6C:F0:54 # A (PARIS)
	...
	sudo rfcomm -i 5C:F3:70:77:1A:85 bind 4 10:00:E8:6C:F0:59 # E (EPFL)
	...
	sudo rfcomm -i 00:02:72:CB:AA:F0 bind 4 10:00:E8:6C:F0:59 # E (EPFL)
	sudo rfcomm -i 00:02:72:CB:AA:F0 bind 5 10:00:E8:6C:F0:5A # F (PARIS)
	sudo rfcomm -i 00:02:72:CB:AA:F0 bind 6 10:00:E8:6C:F0:4E # G (PARIS)
